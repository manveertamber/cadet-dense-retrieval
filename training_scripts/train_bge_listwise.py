...
class Config:
    def __init__(self, dataset='msmarco'):
        ...
        self.train_file_path = f'../reranker/beir.bge.{self.dataset}.train.generated_queries.listwise.jsonl'
        self.dev_file_path = f'../reranker/beir.bge.{self.dataset}.dev.generated_queries.listwise.jsonl'
